              ...
              <div className="stagger-left">
                <div className="mt-4 bg-white/80  p-5 rounded-[20px]">
                  ...
                  <p className="text-xs mb-1 lg:text-sm">
                    ...
                    built from people. Informal practices play a crucial role
                    in:
                  </p>
                ...
                <div className="mt-4 bg-white/80 p-5 rounded-[20px]">
                  ...
                  <p className="text-xs mb-1 lg:text-sm">
                    This website serves as an interactive map of Bremen’s
                    informal urban life. Here, informalities are:
                  </p>
                  <ul className="list-disc text-xs ml-5 lg:text-sm">
                    <li>
                ...
                <div className="mt-4 bg-white/80 p-5 rounded-[20px]">
                  ...
                  <p className="text-xs mb-1 lg:text-sm">
                    Smart Bremen follows an Urban Living Lab approach,
                    combining:
                  </p>
                  <ul className="list-disc text-xs ml-5 lg:text-sm">
                    <li>
                ...
                <div className="mt-4 bg-white/80 p-5 rounded-[20px]">
                  ...
                  <p className="text-xs mb-1 lg:text-sm">
                    ...
                    part of research and teaching in digital media, urban
                    studies, and smart city discourse.
                  </p>
                </div>
              </div>
            </div>
